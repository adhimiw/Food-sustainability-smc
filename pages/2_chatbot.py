"""
FoodFlow AI — Mistral-Powered Chatbot Page
...
TOOLS = [
    {
        ...
        "function": {
            "name": "query_database",
            "description": "Run a SQL query against the FoodFlow DuckDB database to get real-time data.",
            "parameters": {
                "type": "object",
                "properties": {
                    "sql": {
                        "type": "string",
                        "description": "A valid DuckDB SQL query. Available tables: sales, products, stores, inventory, forecasts, waste_cascade_actions, weather, events, routes, suppliers"
                    }
                },
                "required": ["sql"]
            }
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Get a pre-built themed analysis.",
            "parameters": {
                "type": "object",
                "properties": {
                    "theme": {
